        ...
        case 'remove':
            if (chat.welcome) {
              ...
              let wel = await new knights.Welcome()
                ...
                .setAvatar(pp)
                .setBackground("https://telegra.ph/file/fc8c3189134f4d3710923.jpg")
                .toAttachment()
...
global.dfail = (type, m, conn) => {
    let msg = {
        rowner: 'This command can only be used by _*UZUI*_',
        owner: 'This command can only be used by _*OWNER YUKI*_!',
